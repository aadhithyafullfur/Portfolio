...
function About() {
  ...
  useEffect(() => {
    // Desktop: Full animation | Mobile: Simple fade-in
    if (isMobile) {
      // Mobile: Instant visibility with quick fade
      controls.start({
        opacity: 1,
        x: 0,
        rotateX: 0,
  ...
  return (
    <>
      <motion.div
        initial={isMobile ? { opacity: 0 } : { opacity: 0, x: 50, rotateX: -30 }}
        animate={controls}
      ...
      >
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 sm:gap-8 md:gap-10 lg:gap-14">
          ...
          <motion.div
            ...
            initial={isMobile ? { opacity: 0 } : { opacity: 0, x: -20, rotateY: -15 }}
            animate={{ opacity: 1, x: 0, rotateY: 0 }}
            transition={isMobile ? { duration: 0.3 } : { delay: 0.3, duration: 0.8 }}
          ...
          <div className="flex-1 space-y-5 sm:space-y-6 md:space-y-7 text-text-main px-2 sm:px-0 w-full">
            {/* Animated Heading - Mobile: Plain text, Desktop: ScrollFloat */}
            {isMobile ? (
              <h2 className="text-center lg:text-left mb-5 sm:mb-6 text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-extrabold text-purple-400 leading-tight">
                About Me
              </h2>
            ) : (
              <ScrollFloat
            ...
            >
              ...
              <div className="bg-gradient-to-r from-gray-800/30 to-transparent p-3 sm:p-4 md:p-5 rounded-xl border border-gray-700/30">
                {isMobile ? (
                  <>
                    <p className="mb-2 sm:mb-3 text-gray-300 leading-relaxed text-xs sm:text-sm md:text-base">
            ...
            <div className="w-full max-w-3xl">
              ...
              >
                <div className="flex items-center mb-4 sm:mb-5">
                  ...
                  {isMobile ? (
                    <h3 className="flex-1 text-xl sm:text-2xl font-bold text-purple-400">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-l-4 border-purple-500/60 pl-4 bg-gradient-to-r from-purple-500/8 to-transparent p-4 rounded-r-xl">
                    {isMobile ? (
                      <>
                        <p className="mb-1 text-white font-bold text-base sm:text-lg">B.Tech - Artificial Intelligence & Data Science</p>
                        <p className="mb-1 text-purple-300 font-semibold text-sm sm:text-base">Kongu Engineering College</p>
                        <p className="mb-1 text-gray-300 text-xs sm:text-sm">2023 – 2027 | Current Student</p>
                        <p className="text-gray-400 text-xs sm:text-sm">Specializing in Machine Learning, Deep Learning, Data Analytics & Full-Stack Development</p>
                      </>
                    ) : (
                      <>
                        <ScrollFloat
                  ...
                  <div className="border-l-4 border-blue-500/40 pl-4 bg-gradient-to-r from-blue-500/5 to-transparent p-3 rounded-r-xl">
                    {isMobile ? (
                      <>
                        <p className="mb-1 text-white font-semibold text-sm sm:text-base">Higher Secondary Education (HSC)</p>
                        <p className="mb-1 text-blue-300 font-medium text-xs sm:text-sm">PKD Matriculation Hr. Sec. School, Pollachi</p>
                        <p className="text-gray-300 text-xs">2021 – 2023</p>
                      </>
                    ) : (
                      <>
                        <ScrollFloat
                  ...
                  <div className="border-l-4 border-green-500/40 pl-4 bg-gradient-to-r from-green-500/5 to-transparent p-3 rounded-r-xl">
                    {isMobile ? (
                      <>
                        <p className="mb-1 text-white font-semibold text-sm sm:text-base">Secondary School Leaving Certificate (SSLC)</p>
                        <p className="mb-1 text-green-300 font-medium text-xs sm:text-sm">PKD Model Matriculation Higher Secondary School, Pollachi</p>
                        <p className="text-gray-300 text-xs">2020 – 2021</p>
                      </>
                    ) : (
                      <>
                        <ScrollFloat
                ...
                <div className="mt-6 pt-5 border-t border-purple-500/20">
                  {isMobile ? (
                    <h4 className="mb-4 text-lg sm:text-xl font-bold text-purple-400 flex items-center">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-gradient-to-r from-purple-500/8 to-transparent p-4 rounded-xl border border-purple-500/20">
                      {isMobile ? (
                        <>
                          <p className="mb-2 text-white font-semibold text-sm sm:text-base">Data Analytics & Visualization</p>
                    ...
                    <div className="bg-gradient-to-r from-purple-500/8 to-transparent p-4 rounded-xl border border-purple-500/20">
                      {isMobile ? (
                        <>
                          <p className="mb-2 text-white font-semibold text-sm sm:text-base">Creative Arts & Athletics</p>
                          <p className="text-gray-300 text-xs sm:text-sm leading-relaxed">
      ...
      <style>{`
        ...
        /* Mobile: Ensure all content is visible */
        @media (max-width: 768px) {
          /* Force visibility on mobile */
          .space-y-5, .space-y-6, .space-y-7,
          .bg-black\/40, .glass,
          p, h1, h2, h3, h4, h5, h6 {
            opacity: 1 !important;
